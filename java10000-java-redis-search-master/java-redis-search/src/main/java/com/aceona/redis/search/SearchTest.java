...
//        SearchIndex i = new SearchIndex(map1);
//        i.save();
//
//        map1.put("type", "test");
//        map1.put("id", "2");
//        map1.put("title", "Redhat");   
//        i = new SearchIndex(map1);
//        i.save();
//
//        
//        map1.put("type", "test");
...
//        i.save();
        ...
        System.out.println("自动完成: zhang");
        arts = Search.complete("test", "zhang", options);
        for (String artJson : arts)
        {
            Article art = JSON.parseObject(artJson, Article.class);
            System.err.println(art.getId()+ "---"+art.getTitle());
        ...
        arts = Search.query("test", "张", options);
        for (String artJson : arts)
        {
            Article art = JSON.parseObject(artJson, Article.class);
            System.err.println(art.getId()+ "---"+art.getTitle());
