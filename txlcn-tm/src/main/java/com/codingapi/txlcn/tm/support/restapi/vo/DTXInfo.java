...
public class DTXInfo {
    ...
    public int getErrorDtxCount() {
        return errorDtxCount;
    }

    public void setErrorDtxCount(int errorDtxCount) {
        this.errorDtxCount = errorDtxCount;
    }

    public int getTodayDtxCount() {
        return todayDtxCount;
    }

    public void setTodayDtxCount(int todayDtxCount) {
        this.todayDtxCount = todayDtxCount;
    }

    public int getTodayErrorDtxCount() {
        return todayErrorDtxCount;
    }

    public void setTodayErrorDtxCount(int todayErrorDtxCount) {
        this.todayErrorDtxCount = todayErrorDtxCount;
    }
